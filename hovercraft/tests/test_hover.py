...
dict,Python dictionary type,type"""
    ...
    def test_remove_csv_file(self):
        ...
        provider.entries[".py"] = [
            HoverEntry(keyword="print", description="desc1", source_file="/tmp/hovercraft.py.csv"),
            HoverEntry(keyword="list", description="desc2", source_file="/tmp/hovercraft2.py.csv"),
            HoverEntry(keyword="dict", description="desc3", source_file="/tmp/hovercraft.py.csv"),
        ]
...
class TestJSONHoverProvider:
    ...
    def test_load_json_file(self):
        ...
        try:
            ...
            # Check regex flag
            regex_entry = next(e for e in provider.entries[".js"] if e.keyword == "var.*")
    ...
    def test_remove_json_file(self):
        ...
        # Add entries from different files with proper filenames
        provider.entries[".js"] = [
            HoverEntry(keyword="func1", description="desc1", source_file="/tmp/hovercraft.js.json"),
            HoverEntry(keyword="func2", description="desc2", source_file="/tmp/hovercraft2.js.json"),
        ]
